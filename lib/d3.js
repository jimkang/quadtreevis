!function() {
  ...
  d3.geom.quadtree = function(points, x1, y1, x2, y2) {
    ...
    function quadtree(data) {
      ...
      root.remove = function(d) {
        ...
        d3_geom_quadtreeVisit(matchTargetNode, root, x1_, y1_, x2_, y2_, null);
        if (targetNode) {
  ...
  function d3_geom_quadtreeVisit(f, node, x1, y1, x2, y2) {
    if (!f(node, x1, y1, x2, y2)) {
      ...
      if (children[0]) d3_geom_quadtreeVisit(f, children[0], x1, y1, sx, sy, node);
      if (children[1]) d3_geom_quadtreeVisit(f, children[1], sx, y1, x2, sy, node);
      if (children[2]) d3_geom_quadtreeVisit(f, children[2], x1, sy, sx, y2, node);
      if (children[3]) d3_geom_quadtreeVisit(f, children[3], sx, sy, x2, y2, node);
    }
  }
